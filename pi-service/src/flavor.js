...
export const LEAVE_AWAITING_APPROVAL = [
  ...
  '✅ {count} lines written down. Nothing goes to Ollama until you approve session #{meetingId}.',
...
export const QUEUE_PAUSED = [
  '⏸️ Summarising paused. Safe to kill Ollama — nothing will try to reach it.',
  ...
  '💤 Summarising paused. Kill Ollama freely; the queue keeps everything safe.',
  '🗝️ Queue locked. Nothing will be sent to Ollama until you resume.',
  '📜 The quill rests. Summarising is paused.',
  '⚗️ Distillation halted. Nothing will touch your PC until you resume.',
