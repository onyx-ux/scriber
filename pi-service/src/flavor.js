...
export const JOIN_STARTED = [
  ...
  '🧝 An elven chronicler tucks into **{channel}**, ready to immortalize your legend.',
...
export const LEAVE_SUMMARIZING_NOW = [
  ...
  '✅ {count} lines of glory (and rambling) recorded. Summarizing now.',
  '✅ {count} lines saved to the annals. The recap-conjuring begins immediately.',
  "✅ {count} lines transcribed — handing this off to the Oracle for summarizing.",
  ...
  '✅ {count} lines saved. Your friendly neighborhood AI is drafting the recap.',
  '✅ {count} lines of transcript ready. Summarizing on your PC as we speak.',
  ...
  '✅ {count} lines of session lore captured. Summarizing now, stand by.',
  ...
  '✅ Transcribed {count} lines. Summarizing now on your PC...',
];

// {count}, {meetingId}
export const LEAVE_SUMMARY_QUEUED = [
  "✅ {count} lines transcribed, but your PC seems to be off adventuring elsewhere. The recap is queued — or run `/summarize meeting_id:{meetingId}` once it's back.",
  '✅ {count} lines captured. Alas, the Oracle (your PC) is unreachable. It\'ll retry automatically, or use `/summarize meeting_id:{meetingId}`.',
  "✅ {count} lines transcribed. Your PC is either sleeping or elsewhere — the summary will wait patiently in the queue.",
  "✅ Transcription done ({count} lines) — but the summarizing wizard's tower (your PC) is dark. It's queued for when the lights come back on.",
  "✅ {count} lines recorded. The recap-conjuring machine appears to be powered down; I'll keep trying.",
  '✅ {count} lines saved. Your PC\'s Ollama isn\'t answering — queued for automatic retry, or `/summarize meeting_id:{meetingId}` manually.',
  ...
  '✅ {count} lines transcribed. The AI scribe is currently offline — try `/summarize meeting_id:{meetingId}` later.',
  ...
  "✅ Transcribed {count} lines. Your PC's Ollama isn't reachable right now — the summary is queued and will run automatically once it's back, or run `/summarize meeting_id:{meetingId}` after you turn it on.",
];
...
export const SUMMARIZE_UNREACHABLE = [
  ...
  '📡 Signal lost to {url} — the summarizing wizard is still unreachable, but retries continue quietly.',
...
export const SUMMARIZE_QUEUED = [
  ...
  '📜 Meeting #{meetingId} is up next for summarizing — check back shortly.',
  ...
  '🎙️ Re-queued meeting #{meetingId} for summarizing — check back shortly.',
  ...
  '📯 Meeting #{meetingId} announced for another summarizing attempt.',
  '🧝 Meeting #{meetingId} handed back to the chronicler. Check back shortly.',
  '⛩️ Meeting #{meetingId} placed back on the altar for summarizing.',
...
export const STATUS_IDLE = [
  "😴 Nothing queued for summarizing right now. Your PC's Ollama is currently {reachable}.",
  "🧙 All caught up — nothing waiting to be summarized. Ollama is currently {reachable}.",
  ...
  "No sessions currently queued for summarization. Your PC's Ollama is currently {reachable}.",
];
...
export const STATUS_QUEUED_HEADER = [
  ...
  "🎙️ Ollama is currently {reachable}. On the tape, unsummarized:\n\n**Queued:**",
...
export const POST_SESSION_ATTACHMENT_CAPTION = [
  ...
  '📎 The whole session, transcribed and summarized, for your vault:',
  ...
  '📎 Everything said and summarized, packaged for Obsidian:',
